  ...
  const socialLinks = [
    {
      icon: Github,
      name: 'GitHub',
      href: 'https://github.com/seojaehong',
      color: 'hover:bg-gray-900'
    },
    {
      icon: Linkedin,
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/seojaehong',
      color: 'hover:bg-blue-600'
    },
    {
      icon: Twitter,
      name: 'Twitter',
      href: 'https://twitter.com/seojaehong',
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">연락 정보</h2>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`w-12 h-12 bg-white rounded-lg shadow-md flex items-center justify-center text-gray-600 ${social.color} text-white transition-all duration-300 hover:scale-110`}
                  >
